...
class Inpaint3DMRDataset(data.Dataset):
    """
    3D Inpainting MRA Dataset for medical images with bounding box annotations.
    ...
    def __init__(self, data_root, csv_path, mask_size_range=(10, 30), 
                 ...
                 normalization='nnunet', foreground_percentiles=(0.5, 99.5),
                 global_mean=None, global_std=None, image_size=None):
        super(Inpaint3DMRDataset, self).__init__()
        ...
        uid_to_modality = (
            df[['SeriesInstanceUID', 'Modality']]
            .drop_duplicates()
            .set_index('SeriesInstanceUID')['Modality']
            .to_dict()
            )
        ...
        for nifti_file in nifti_files:
            ...
            if uid not in uid_to_modality:
                continue
                
            if uid_to_modality[uid] != 'MRA':
                continue
...
class Inpaint3DMRNullMaskDataset(data.Dataset):
    """
    3D Inpainting MRA Dataset for medical images with bounding box annotations.
    ...
    def __init__(self, data_root, csv_path, mask_size_range=(10, 30), 
                 ...
                 normalization='nnunet', foreground_percentiles=(0.5, 99.5),
                 global_mean=None, global_std=None, image_size=None):
        super(Inpaint3DMRNullMaskDataset, self).__init__()
    ...
    def __getitem__(self, index):
        ...
        # Create mask image for visualization
        mask_image = image_tensor * (1. - mask_tensor)
...
class Inpaint3DMREXPDataset(data.Dataset):
    """
    3D Inpainting MRA Dataset for medical images with bounding box annotations.
    ...
    def __init__(self, data_root, csv_path, mask_size_range=(10, 30), 
                 ...
                 normalization='nnunet', foreground_percentiles=(0.5, 99.5),
                 global_mean=None, global_std=None, image_size=None):
        super(Inpaint3DMREXPDataset, self).__init__()
...
class Inpaint3DCTEXPDataset(data.Dataset):
    """
    3D Inpainting MRA Dataset for medical images with bounding box annotations.
    ...
    def __init__(self, data_root, csv_path, mask_size_range=(10, 30), 
                 ...
                 normalization='nnunet', foreground_percentiles=(0.5, 99.5),
                 global_mean=None, global_std=None, image_size=None):
        super(Inpaint3DCTEXPDataset, self).__init__()
...
class Inpaint3DCT_RANDOMSELECTBOX_Dataset(data.Dataset):
    """
    3D Inpainting MRA Dataset for medical images with bounding box annotations.
    ...
    def __init__(self, data_root, csv_path, mask_size_range=(10, 30), 
                 ...
                 normalization='nnunet', foreground_percentiles=(0.5, 99.5),
                 global_mean=None, global_std=None, image_size=None):
        super(Inpaint3DCT_RANDOMSELECTBOX_Dataset, self).__init__()
    ...
    def __getitem__(self, index):
        ...
        for bbox in bboxes:
            # Randomly select mask size for each dimension
            size_x = np.random.randint(15, 16)
            size_y = np.random.randint(15, 16)
            size_z = np.random.randint(15, 16)
            ...
            if use_sphere:
                ...
                bbox_mask = sphere3d_to_mask(
                    img_shape=(width, height, depth),
                    center_x=random.randint(int(width/4), int(3*width/4)),
                    center_y=random.randint(int(width/4), int(3*width/4)),
                    center_z=random.randint(int(width/4), int(3*width/4)),
                    radius=radius
                )
            else:
                # Use cuboid mask (original method)
...
class Inpaint3DMRCTEXPDataset(data.Dataset):
    """
    3D Inpainting MRA Dataset for medical images with bounding box annotations.
    ...
    def __init__(self, data_root, csv_path, mask_size_range=(10, 30), 
                 ...
                 normalization='nnunet', foreground_percentiles=(0.5, 99.5),
                 global_mean=None, global_std=None, image_size=None):
        super(Inpaint3DMRCTEXPDataset, self).__init__()
        ...
        for nifti_file in nifti_files:
            ...
            if uid_to_modality[uid] not in  ['MRA', 'CTA']:
                continue
    ...
    def __getitem__(self, index):
        ...
        if self.normalization == 'nnunet':
            ...
            # Use simple normalization
            if modality == 'MRA':
                image_normalized = ct_normalize_simple(image_data, 0, 5000)
            elif modality == 'CTA':
                image_normalized = ct_normalize_simple(image_data, self.hu_min, self.hu_max)
...
class Inpaint3DCT_XYZ_Dataset(data.Dataset):
    """
    3D Inpainting MRA Dataset for medical images with bounding box annotations.
    ...
    def __init__(self, data_root, csv_path, mask_size_range=(10, 30), 
                 ...
                 normalization='nnunet', foreground_percentiles=(0.5, 99.5),
                 global_mean=None, global_std=None, image_size=None):
        super(Inpaint3DCT_XYZ_Dataset, self).__init__()
